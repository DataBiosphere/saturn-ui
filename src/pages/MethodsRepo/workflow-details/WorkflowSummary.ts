...
import { wrapWorkflows } from 'src/pages/MethodsRepo/workflow-details/WorkflowWrapper';
import { WorkflowRightBoxSection } from 'src/workflows/methods-repo/WorkflowRightBoxSection';
